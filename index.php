...
<main id="top">
  <section class="hero" id="hero">
    <div class="hero-slides" aria-live="polite">
      <?php for ($slide = 1; $slide <= 3; $slide++): ?><div class="hero-image <?= $slide === 1 ? 'active' : '' ?>"><video class="hero-video desktop-video" muted loop playsinline preload="metadata"><source src="https://cdn.pelish.co/hero/masaustu<?= $slide ?>.mp4" type="video/mp4"></video><video class="hero-video mobile-video" muted loop playsinline preload="metadata"><source src="https://cdn.pelish.co/hero/<?= $slide ?>.mp4" type="video/mp4"></video></div><?php endfor; ?>
    </div>

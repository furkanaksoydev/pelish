...
Yüklemeye hazır dosyalar proje dışındaki `C:\xampp\htdocs\pelish-canli-yukleme-final-v4` klasöründe, aynı içeriğin ZIP sürümü ise `C:\xampp\htdocs\pelish-canli-yukleme-final-v4.zip` dosyasındadır. Hostingin belge köküne yalnızca bu paketin **içeriğini** yükleyin.

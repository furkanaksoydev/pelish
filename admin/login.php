...
?>
<!doctype html><html lang="tr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="robots" content="noindex,nofollow"><link rel="icon" href="https://cdn.pelish.co/logo.png" type="image/png"><link rel="apple-touch-icon" href="https://cdn.pelish.co/logo.png"><title>Yönetici girişi · pelish</title><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=DM+Mono&family=DM+Sans:wght@400;500;600;700&display=swap"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css"><link rel="stylesheet" href="assets/pelish-admin-console.css?v=20260823"></head><body class="admin-auth-body"><main class="admin-auth-card"><a class="panel-logo" href="../index.php"><img src="https://cdn.pelish.co/logo.png" alt="pelish"></a><p>YÖNETİM PANELİ</p><h1>Giriş yap.</h1><span>Bu alan yalnızca yetkili yöneticiler içindir.</span><?php if ($error): ?><div class="admin-login-error"><?= e($error) ?></div><?php endif; ?><form method="post"><input type="hidden" name="csrf" value="<?= e(csrf_token()) ?>"><label>Kullanıcı adı<input required name="username" autocomplete="username"></label><label>Şifre<input required type="password" name="password" autocomplete="current-password"></label><button class="button primary" type="submit">Panele gir <i class="fa-solid fa-arrow-right"></i></button></form><a href="../index.php">← Mağazaya dön</a></main></body></html>

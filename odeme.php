...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    store_verify_csrf();
    $paymentMethod = (string) ($_POST['payment_method'] ?? 'transfer');
    ...
    try {
        ...
        $order = $customer ? store_create_manual_payment_order($pdo, $customer, $addressId, $termsAccepted, $kvkkAccepted, $marketingConsent, $config, 'Havale / EFT') : store_create_guest_transfer_order($pdo, ['first_name'=>trim((string)($_POST['guest_first_name']??'')),'last_name'=>trim((string)($_POST['guest_last_name']??'')),'email'=>trim((string)($_POST['guest_email']??'')),'phone'=>trim((string)($_POST['guest_phone']??'')),'city'=>trim((string)($_POST['guest_city']??'')),'district'=>trim((string)($_POST['guest_district']??'')),'address_line'=>trim((string)($_POST['guest_address_line']??''))], $termsAccepted, $kvkkAccepted, $config);
